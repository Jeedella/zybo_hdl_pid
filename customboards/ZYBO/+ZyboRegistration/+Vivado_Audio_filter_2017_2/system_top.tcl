...
proc create_root_design { parentCell } {
  ...
  set DUT_to_I2S [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:1.1 DUT_to_I2S ]
  set_property -dict [ list \
CONFIG.IS_ACLK_ASYNC {1} \
 ] $DUT_to_I2S

  # Create instance: I2S_to_DUT, and set properties
  set I2S_to_DUT [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:1.1 I2S_to_DUT ]
  set_property -dict [ list \
CONFIG.IS_ACLK_ASYNC {1} \
 ] $I2S_to_DUT

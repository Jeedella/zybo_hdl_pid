...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set Bit_clock [ create_bd_port -dir I Bit_clock ]
  set I2C_CLK [ create_bd_port -dir O -type clk I2C_CLK ]
  ...
  set PBCLK [ create_bd_port -dir I PBCLK ]
  set RECLK [ create_bd_port -dir I RECLK ]
  set Serial_data_in [ create_bd_port -dir I Serial_data_in ]
  set Serial_data_out [ create_bd_port -dir O Serial_data_out ]

  # Create instance: DUT_to_I2S, and set properties
  set DUT_to_I2S [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 DUT_to_I2S ]
  set_property -dict [ list \
CONFIG.IS_ACLK_ASYNC {1} \
 ] $DUT_to_I2S

  # Create instance: I2S_to_DUT, and set properties
  set I2S_to_DUT [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 I2S_to_DUT ]
  set_property -dict [ list \
CONFIG.IS_ACLK_ASYNC {1} \
 ] $I2S_to_DUT

  # Create instance: Interconnect_IP, and set properties
  set Interconnect_IP [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 Interconnect_IP ]
  set_property -dict [ list \
CONFIG.NUM_MI {3} \
 ] $Interconnect_IP
  ...
  # Create instance: Reset_50MHz, and set properties
  set Reset_50MHz [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 Reset_50MHz ]

  # Create instance: Zybo_I2C_IP_0, and set properties
  set Zybo_I2C_IP_0 [ create_bd_cell -type ip -vlnv mathworks.com:ip:I2C_SSM2603:1.0 Zybo_I2C_IP_0 ]

  # Create instance: Zybo_I2S_IP_0, and set properties
  set Zybo_I2S_IP_0 [ create_bd_cell -type ip -vlnv mathworks.com:ip:I2S_SSM2603:1.0 Zybo_I2S_IP_0 ]
...
CONFIG.PCW_WDT_WDT_IO.VALUE_SRC {DEFAULT} \
  ...
  connect_bd_intf_net -intf_net DUT_to_I2S_M_AXIS [get_bd_intf_pins DUT_to_I2S/M_AXIS] [get_bd_intf_pins Zybo_I2S_IP_0/AXI4_Stream_Slave]
  connect_bd_intf_net -intf_net Zybo_I2S_IP_0_AXI4_Stream_Master [get_bd_intf_pins I2S_to_DUT/S_AXIS] [get_bd_intf_pins Zybo_I2S_IP_0/AXI4_Stream_Master]
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins Interconnect_IP/M00_AXI] [get_bd_intf_pins Zybo_I2C_IP_0/AXI4_Lite]
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins Interconnect_IP/M01_AXI] [get_bd_intf_pins Zybo_I2S_IP_0/AXI4_Lite]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins Interconnect_IP/S00_AXI] [get_bd_intf_pins processing_system/M_AXI_GP0]

  # Create port connections
  connect_bd_net -net Bit_clock_1 [get_bd_ports Bit_clock] [get_bd_pins Zybo_I2S_IP_0/Bit_clock]
  connect_bd_net -net Net [get_bd_ports I2C_DATA] [get_bd_pins Zybo_I2C_IP_0/I2C_DATA]
  connect_bd_net -net Net1 [get_bd_pins DUT_to_I2S/m_axis_aresetn] [get_bd_pins I2S_to_DUT/s_axis_aresetn] [get_bd_pins Interconnect_IP/M00_ARESETN] [get_bd_pins Interconnect_IP/M01_ARESETN] [get_bd_pins Interconnect_IP/S00_ARESETN] [get_bd_pins Reset_50MHz/peripheral_aresetn] [get_bd_pins Zybo_I2C_IP_0/AXI4_Lite_ARESETN] [get_bd_pins Zybo_I2C_IP_0/IPCORE_RESETN] [get_bd_pins Zybo_I2S_IP_0/AXI4_Lite_ARESETN] [get_bd_pins Zybo_I2S_IP_0/IPCORE_RESETN]
  connect_bd_net -net PBCLK_1 [get_bd_ports PBCLK] [get_bd_pins Zybo_I2S_IP_0/PBCLK]
  connect_bd_net -net RECLK_1 [get_bd_ports RECLK] [get_bd_pins Zybo_I2S_IP_0/RECLK]
  connect_bd_net -net Reset_50MHz_interconnect_aresetn [get_bd_pins Interconnect_IP/ARESETN] [get_bd_pins Reset_50MHz/interconnect_aresetn]
  connect_bd_net -net S00_ARESETN_1 [get_bd_pins DUT_to_I2S/s_axis_aresetn] [get_bd_pins I2S_to_DUT/m_axis_aresetn] [get_bd_pins Interconnect_IP/M02_ARESETN] [get_bd_pins Reset_100MHz/peripheral_aresetn]
  connect_bd_net -net Serial_data_in_1 [get_bd_ports Serial_data_in] [get_bd_pins Zybo_I2S_IP_0/Serial_data_in]
  connect_bd_net -net Zybo_I2C_IP_0_I2C_CLK [get_bd_ports I2C_CLK] [get_bd_pins Zybo_I2C_IP_0/I2C_CLK]
  connect_bd_net -net Zybo_I2C_IP_0_MUTEN [get_bd_ports MUTEN] [get_bd_pins Zybo_I2C_IP_0/MUTEN]
  connect_bd_net -net Zybo_I2S_IP_0_Serial_data_out [get_bd_ports Serial_data_out] [get_bd_pins Zybo_I2S_IP_0/Serial_data_out]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins DUT_to_I2S/m_axis_aclk] [get_bd_pins I2S_to_DUT/s_axis_aclk] [get_bd_pins Interconnect_IP/ACLK] [get_bd_pins Interconnect_IP/M00_ACLK] [get_bd_pins Interconnect_IP/M01_ACLK] [get_bd_pins Interconnect_IP/S00_ACLK] [get_bd_pins Reset_50MHz/slowest_sync_clk] [get_bd_pins Zybo_I2C_IP_0/AXI4_Lite_ACLK] [get_bd_pins Zybo_I2C_IP_0/IPCORE_CLK] [get_bd_pins Zybo_I2S_IP_0/AXI4_Lite_ACLK] [get_bd_pins Zybo_I2S_IP_0/IPCORE_CLK] [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins processing_system/M_AXI_GP0_ACLK]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins DUT_to_I2S/s_axis_aclk] [get_bd_pins I2S_to_DUT/m_axis_aclk] [get_bd_pins Interconnect_IP/M02_ACLK] [get_bd_pins Reset_100MHz/slowest_sync_clk] [get_bd_pins clk_wiz_0/clk_out1]
  connect_bd_net -net clk_wiz_0_clk_out3 [get_bd_ports MCLK] [get_bd_pins clk_wiz_0/clk_out3]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins Reset_100MHz/dcm_locked] [get_bd_pins clk_wiz_0/locked]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins processing_system/FCLK_CLK0]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins Reset_100MHz/ext_reset_in] [get_bd_pins Reset_50MHz/ext_reset_in] [get_bd_pins clk_wiz_0/resetn] [get_bd_pins processing_system/FCLK_RESET0_N]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system/Data] [get_bd_addr_segs Zybo_I2C_IP_0/AXI4_Lite/reg0] SEG_Zybo_I2C_IP_0_reg0
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system/Data] [get_bd_addr_segs Zybo_I2S_IP_0/AXI4_Lite/reg0] SEG_Zybo_I2S_IP_0_reg0
...
preplace port Bit_clock -pg 1 -y 600 -defaultsOSRD
preplace port I2C_CLK -pg 1 -y 290 -defaultsOSRD
preplace port MCLK -pg 1 -y 20 -defaultsOSRD
preplace port PBCLK -pg 1 -y 660 -defaultsOSRD
preplace port RECLK -pg 1 -y 620 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 90 -defaultsOSRD
preplace port Serial_data_out -pg 1 -y 580 -defaultsOSRD
preplace port MUTEN -pg 1 -y 310 -defaultsOSRD
preplace port I2C_DATA -pg 1 -y 270 -defaultsOSRD
preplace port Serial_data_in -pg 1 -y 640 -defaultsOSRD
preplace inst Zybo_I2C_IP_0 -pg 1 -lvl 5 -y 290 -defaultsOSRD
preplace inst Zybo_I2S_IP_0 -pg 1 -lvl 5 -y 570 -defaultsOSRD
preplace inst Reset_50MHz -pg 1 -lvl 2 -y 450 -defaultsOSRD
preplace inst processing_system -pg 1 -lvl 3 -y 140 -defaultsOSRD
preplace inst Interconnect_IP -pg 1 -lvl 4 -y 270 -defaultsOSRD
preplace inst I2S_to_DUT -pg 1 -lvl 3 -y 520 -defaultsOSRD
preplace inst Reset_100MHz -pg 1 -lvl 2 -y 270 -defaultsOSRD
preplace inst DUT_to_I2S -pg 1 -lvl 4 -y 530 -defaultsOSRD
preplace inst clk_wiz_0 -pg 1 -lvl 1 -y 100 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 3 3 NJ 70 NJ 70 NJ
preplace netloc Zybo_I2C_IP_0_I2C_CLK 1 5 1 NJ
preplace netloc Reset_50MHz_interconnect_aresetn 1 2 2 550 270 NJ
preplace netloc PBCLK_1 1 0 5 NJ 660 NJ 660 NJ 660 NJ 660 NJ
preplace netloc Zybo_I2C_IP_0_MUTEN 1 5 1 NJ
preplace netloc processing_system7_0_M_AXI_GP0 1 3 1 N
preplace netloc DUT_to_I2S_M_AXIS 1 4 1 N
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 4 20 180 200 180 NJ 260 940
preplace netloc RECLK_1 1 0 5 NJ 620 NJ 620 NJ 620 NJ 620 NJ
preplace netloc Serial_data_in_1 1 0 5 NJ 640 NJ 640 NJ 640 NJ 640 NJ
preplace netloc processing_system7_0_FIXED_IO 1 3 3 NJ 90 NJ 90 NJ
preplace netloc clk_wiz_0_clk_out1 1 1 3 210 160 540 350 950
preplace netloc clk_wiz_0_locked 1 1 1 180
preplace netloc Zybo_I2S_IP_0_AXI4_Stream_Master 1 2 4 580 710 NJ 710 NJ 710 1680
preplace netloc axi_interconnect_0_M00_AXI 1 4 1 N
preplace netloc Bit_clock_1 1 0 5 NJ 630 NJ 630 NJ 630 NJ 630 NJ
preplace netloc clk_wiz_0_clk_out2 1 1 4 190 140 560 280 960 100 1360
preplace netloc axi_interconnect_0_M01_AXI 1 4 1 1350
preplace netloc Net1 1 2 3 570 430 980 110 1340
preplace netloc Net 1 5 1 NJ
preplace netloc processing_system7_0_FCLK_CLK0 1 0 4 10 20 NJ 20 NJ 20 940
preplace netloc clk_wiz_0_clk_out3 1 1 5 NJ 10 NJ 10 NJ 10 NJ 10 NJ
preplace netloc Zybo_I2S_IP_0_Serial_data_out 1 5 1 NJ
preplace netloc S00_ARESETN_1 1 2 2 530 370 970
levelinfo -pg 1 -10 100 370 760 1150 1520 1700 -top 0 -bot 720
",
}
